...
export default function ContentCard({ title, type, source, description, imageUrl, dataAiHint, category }: ContentCardProps) {
  return (
    <Card className="flex flex-col overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 h-full">
      ...
      <CardFooter>
        <Button asChild className="w-full" variant="outline">
          {/* This link would ideally go to an internal page or the external source */}
