...
export const mockContent: ContentItem[] = [
  { id: '1', title: 'Understanding JavaScript Closures', type: 'Article', source: 'MDN Web Docs', description: "A deep dive into closures, a fundamental concept in JavaScript that allows functions to remember their lexical scope even when executed outside that scope.", imageUrl: "https://picsum.photos/seed/js-closure/600/400", dataAiHint: "code editor", category: "Core Concepts", externalLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Closures", createdAt: new Date('2023-01-10T10:00:00Z') },
  { id: '2', title: 'Asynchronous JavaScript with Async/Await', type: 'Tutorial', source: 'JavaScript.info', description: "Learn how to handle asynchronous operations gracefully using async/await, making your code cleaner and easier to understand compared to traditional Promises or callbacks.", imageUrl: "https://picsum.photos/seed/async-js/600/400", dataAiHint: "network nodes", category: "Asynchronous JS", externalLink: "https://javascript.info/async-await", createdAt: new Date('2023-01-15T11:00:00Z') },
  { id: '3', title: 'React State Management with Hooks', type: 'Documentation', source: 'React Official Docs', description: "Official documentation on using useState and useEffect for managing component state and side effects in React functional components.", imageUrl: "https://picsum.photos/seed/react-hooks/600/400", dataAiHint: "react logo", category: "React", externalLink: "https://react.dev/reference/react/useState", createdAt: new Date('2023-02-01T14:30:00Z') },
  { id: '4', title: 'Building a REST API with Node.js and Express', type: 'Article', source: 'Smashing Magazine', description: "A comprehensive guide to creating backend APIs using Node.js and the Express framework, covering routing, middleware, and best practices.", imageUrl: "https://picsum.photos/seed/nodejs-express/600/400", dataAiHint: "server database", category: "Node.js", externalLink: "https://www.smashingmagazine.com/2021/01/nodejs-express-tutorial-rest-api/", createdAt: new Date('2023-02-20T09:00:00Z') },
  { id: '5', title: 'CSS Grid Layout Tutorial', type: 'Tutorial', source: 'CSS-Tricks', description: "Master the powerful CSS Grid for creating complex two-dimensional web layouts with more control and flexibility than older methods.", imageUrl: "https://picsum.photos/seed/css-grid/600/400", dataAiHint: "layout grid", category: "CSS", externalLink: "https://css-tricks.com/getting-started-css-grid/", createdAt: new Date('2023-03-05T16:00:00Z') },
  { id: '6', title: 'Introduction to TypeScript', type: 'Documentation', source: 'TypeScriptLang.org', description: "Get started with TypeScript, a superset of JavaScript that adds static typing, to build more robust and maintainable applications.", imageUrl: "https://picsum.photos/seed/typescript-intro/600/400", dataAiHint: "typescript logo", category: "TypeScript", externalLink: "https://www.typescriptlang.org/docs/handbook/typescript-in-5-minutes.html", createdAt: new Date('2023-03-10T10:30:00Z') },
  { id: '7', title: 'JavaScript Promises: An In-Depth Guide', type: 'Article', source: 'Web Dev Simplified', description: "A detailed explanation of JavaScript Promises, how they work, and how to use them effectively for handling asynchronous operations.", imageUrl: "https://picsum.photos/seed/js-promises/600/400", dataAiHint: "promise chain", category: "Asynchronous JS", externalLink: "https://blog.webdevsimplified.com/2020-05/javascript-promises/", createdAt: new Date('2023-04-01T11:15:00Z') },
  { id: '8', title: 'React Router: Declarative Routing for React', type: 'Documentation', source: 'React Router Docs', description: "Learn how to implement client-side routing in your React applications using React Router for seamless navigation.", imageUrl: "https://picsum.photos/seed/react-router/600/400", dataAiHint: "navigation map", category: "React", externalLink: "https://reactrouter.com/en/main", createdAt: new Date('2023-04-12T13:00:00Z') },
];

// Ensure all courses in roadmaps have a displayOrder for consistency
